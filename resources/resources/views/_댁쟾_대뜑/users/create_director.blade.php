  ...
  <div class="main-wrapper">
    ...
    <form action="{{ route('users.store') }}" method="POST" role="form" class="form">
      ...
      <section class="mainContent full-width clearfix" id="join_1">
        <h1 class="bg-color-4" style="text-align:center; color:white;">원장 회원가입</h1>
        <hr>
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-sm-4 col-sm-push-8 col-xs-12" st>
              <div class="panel-heading bg-color-3 border-color-3">
                <h3 style="font-size:x-large; color:white;" class="panel-title">원장님 사진</h3>
              </div>
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    <div class="col-sm-4 col-xs-12">
                      ...
                      <input type="number" class="form-control border-color-2" id="" required="">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-6 col-xs-12">
                      <label for="">ID 입력</label>
                      <input type="email" name='user_id' class="form-control border-color-3" id="" placeholder="이메일주소" required="">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-6 col-xs-12">
                  ...
                  <div class="form-group">
                    <div class="col-xs-12">
                      <hr>
                      <label for="">원장님 사진을 선택해주세요</label>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-sm-10 col-xs-12">
              ...
              <div class="panel panel-default checkoutInfo">
                <div class="panel-heading bg-color-3 border-color-3">
                  <h3 class="panel-title">유치원 정보 입력</h3>
                </div>
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    <div class="col-sm-4 col-xs-12">
                      ...
                      <input type="text" name='kgName' class="form-control border-color-1" id="" required="">
                    </div>
                  </div>
                    ...
                    <div class="col-sm-4 col-xs-12">
                      ...
                      <div class="bookingDrop">
                        <select name="address" class="select-drop">
                              ...
                              <option value="zezudo">제주도</option>
                  ...
                  <div class="form-group">
                    <div class="col-sm-4 col-xs-12">
                      <label for="">유치원 연락처</label>
                      <input type="text" name='phoneNum' class="form-control border-color-1" id="" required="">
                    </div>
                  </div>

                  <div class="form-group">
                    <div class="col-xs-12">
                      <label for="">유치원에 관한 간단한 설명</label>
                      <textarea class="form-control border-color-2"></textarea>
                    </div>
                  </div>
          ...
          <div class="panel-body">
            <form action="#" method="POST" role="form">
              <div class="form-group formField">
                <input type="email" name="user_id" class="form-control" placeholder="ex) exam01@example.com">
              </div>
              <div class="form-group formField">
